...
export const createRover = async (hotelId: string): Promise<any> => {
...
export const addOrder = async (roverId: string, orderId: string, exchange: boolean): Promise<any> => {
...
export const deliveredOrder = async (roverId: string, orderId: string, exchange: boolean): Promise<any> => {
...
export const getFullPaths = async (roverId: string): Promise<any> => {
  const rover = await prisma.rover.findUnique({
    where: {
      id: roverId
    },
...
export const getOptimizedPath = async (path1: string[], path2: string[]): Promise<any> => {
  const path = []
